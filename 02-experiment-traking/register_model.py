...
HPO_EXPERIMENT_NAME = "02-experiment-tracking-hyperopt"
EXPERIMENT_NAME = "02-experiment-tracking-best-models"
...
def run_register_model(data_path: str, top_n: int):
    ...
    # Log the models in the new experiment
    for run in runs:
        train_and_log_model(data_path=data_path, params=run.data.params)

    # Retrieve the logged runs from the new experiment
